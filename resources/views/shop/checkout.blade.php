                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" value="{{ Auth::user()->nama }}" readonly class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-500 cursor-not-allowed">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">No. Telepon <span class="text-red-500">*</span></label>
                                <input type="tel" name="shipping_phone" value="{{ old('shipping_phone', Auth::user()->patient->no_hp ?? '') }}" required placeholder="Contoh: 08123456789" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-28">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex justify-between items-start text-sm">
                            <span class="text-gray-600 flex-1 pr-2">{{ $item->medication->nama }} <span class="text-xs text-gray-400">x{{ $item->quantity }}</span></span>
