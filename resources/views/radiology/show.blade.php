    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6 flex justify-between items-start">
            <div>
                ...
                <p class="text-gray-600 mt-2">{{ $radiology->nomor_permintaan }}</p>
            </div>
            <div class="flex space-x-2">
                @if(in_array($radiology->status, ['menunggu', 'sedang_diproses']))
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-gray-800 mt-1">{{ $radiology->catatan_klinis }}</p>
                    </div>
                    @endif
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mb-4">
                        <p class="text-gray-800">{{ $radiology->hasil }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div>
                        <p class="text-gray-800">{{ $radiology->interpretasi }}</p>
                    </div>
                </div>
                @endif
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <p>{{ $radiology->pasien->jenis_kelamin === 'laki_laki' ? 'Laki-laki' : 'Perempuan' }}</p>
                        </div>
                        <div>
...
<div id="interpretationModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form action="{{ route('radiology.enter-interpretation', $radiology) }}" method="POST">
            @csrf
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <textarea name="hasil" rows="4" required
                        ...
                        placeholder="Deskripsi hasil pemeriksaan radiologi...">{{ old('hasil', $radiology->hasil) }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Interpretasi</label>
                    <textarea name="interpretasi" rows="4" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                        placeholder="Interpretasi medis dari hasil pemeriksaan...">{{ old('interpretasi', $radiology->interpretasi) }}</textarea>
                </div>
            </div>
