                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="spesialisasi" id="specialization" required value="{{ old('specialization') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_lisensi" id="license_number" required value="{{ old('license_number') }}"
