        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">{{ $department->nama }}</h1>
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-3xl py-16 px-8 mb-6 animate-pulse">
                            <div class="text-9xl font-black" id="current-queue">
                                {{ $currentQueue ? $currentQueue->queue_code : '---' }}
                            </div>
                        </div>
                        @if($currentQueue)
                        <div class="text-3xl text-gray-700 font-semibold">
                            {{ $currentQueue->pasien->nama }}
                        </div>
                        <div class="text-xl text-gray-500 mt-2">
                            Dr. {{ $currentQueue->dokter->user->nama }}
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6">
                    ...
                    <div class="space-y-3 max-h-[600px] overflow-y-auto">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-center">
                                <div>
                                    <div class="text-3xl font-bold text-blue-600">{{ $queue->queue_code }}</div>
                                    <div class="text-sm text-gray-600 mt-1">{{ Str::limit($queue->pasien->nama, 20) }}</div>
                                </div>
                                <div class="text-right">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600">{{ $currentQueue ? 1 : 0 }}</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-600">{{ $waitingQueue->count() }}</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-600">{{ $completedToday }}</p>
                    </div>
