...
<head>
    <meta charset="UTF-8">
    <title>Queue Ticket - {{ $appointment->queue_code }}</title>
    <style>
        @page {
            size: 80mm auto;
            margin: 0;
...
<body>
    ...
    <div class="queue-number">
        ...
        <div class="queue-code">{{ $appointment->queue_code }}</div>
    </div>

    <div class="barcode">
        <div class="barcode-value">*{{ $appointment->queue_code }}*</div>
    </div>

    <div class="info-section">
        <div class="info-row">
            <span class="info-label">Pasien:</span>
            <span class="info-value">{{ Str::limit($appointment->pasien->nama, 20) }}</span>
        </div>
        <div class="info-row">
            <span class="info-label">No. RM:</span>
            <span class="info-value">{{ $appointment->pasien->no_rekam_medis }}</span>
        </div>
        <div class="info-row">
            <span class="info-label">Poliklinik:</span>
            <span class="info-value">{{ $appointment->departemen->nama }}</span>
        </div>
        <div class="info-row">
            <span class="info-label">Dokter:</span>
            <span class="info-value">Dr. {{ Str::limit($appointment->dokter->user->nama, 18) }}</span>
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
            ...
            <span class="info-value">{{ $appointment->checked_in_at->format('H:i') }}</span>
        </div>
    </div>
