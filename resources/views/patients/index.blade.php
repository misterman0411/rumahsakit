                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-bold text-blue-600">{{ $patient->no_rekam_medis }}</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            ...
                            <span class="text-xs text-gray-500">({{ \Carbon\Carbon::parse($patient->tanggal_lahir)->age }} years)</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($patient->jenis_kelamin === 'laki_laki')
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @elseif($patient->status === 'tidak_aktif')
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                            <a href="{{ route('patients.show', $patient) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold">
                            ...
                            @if(auth()->user()->hasAnyRole(['front_office', 'admin']))
                            <a href="{{ route('patients.edit', $patient) }}" class="inline-flex items-center text-green-600 hover:text-green-800 font-semibold">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
