                ...
                <div class="ml-10 flex items-baseline space-x-8">
                    ...
                    @auth
                        @if(Auth::user()->isPatient())
                            <a href="{{ route('patient.dashboard') }}" class="{{ request()->routeIs('patient.dashboard') ? 'text-indigo-600' : 'text-gray-600 hover:text-indigo-600' }} font-medium px-3 py-2 rounded-md text-base transition-colors">Dashboard</a>
                        @endif
                    @endauth
                </div>
            </div>
                    ...
                    @auth
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-100 py-1 hidden group-hover:block z-50">
                                ...
                                <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
                                    Edit Profile
                                </a>
