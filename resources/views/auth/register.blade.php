...
<div class="min-h-screen flex items-center justify-center p-4 relative">
    <!-- Back Button -->
    <a href="{{ url('/') }}" class="absolute top-6 left-6 md:top-8 md:left-8 flex items-center gap-2 text-gray-500 hover:text-indigo-600 transition-all duration-300 z-50 group">
        ...
        <div class="w-full md:w-1/2 p-12 flex flex-col justify-center bg-white relative order-2 md:order-2">
            <div class="max-w-md mx-auto w-full">
                ...
                <p class="text-gray-500 mb-8 text-sm bg-gray-50 p-4 rounded-xl border border-gray-100">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-indigo-600 font-bold hover:text-indigo-700 transition-colors">Login disini</a>
                </p>
