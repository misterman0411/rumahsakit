...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <h2 class="text-lg font-bold text-gray-800 mb-4">Recent Stock Movements ({{ ucfirst($period) }})</h2>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <div class="font-bold">{{ $movement->obat->nama }}</div>
                            <div class="text-xs text-gray-500">{{ $movement->obat->kode }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                {{ $movement->jenis_mutasi === 'masuk' ? 'bg-green-100 text-green-800' : 
                                   ($movement->jenis_mutasi === 'keluar' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800') }}">
                                {{ ucfirst($movement->jenis_mutasi) }}
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-bold {{ $movement->jenis_mutasi === 'masuk' ? 'text-green-600' : 'text-red-600' }}">
