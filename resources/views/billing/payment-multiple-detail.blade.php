                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="mt-1 text-lg text-gray-900 font-semibold">{{ count($invoices) }} invoices</p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500">Payment Date</label>
                            <p class="mt-1 text-gray-900">{{ now()->format('d F Y H:i') }}</p>
                        </div>
                        <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <div class="text-right">
                                <p class="text-xl font-bold text-blue-600">Rp {{ number_format($invoice->total, 0, ',', '.') }}</p>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <div class="space-y-3">
                        ...
                        <div class="border-t-2 border-gray-300 pt-3 flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-green-600">Rp {{ number_format($totalAmount, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            <li>All {{ count($invoices) }} invoices will be paid at once</li>
...
<div id="manualPaymentModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-lg bg-white">
        ...
        <form action="{{ route('billing.payment-multiple') }}" method="POST">
            @csrf
            <input type="hidden" name="tagihan_ids" value="{{ json_encode($invoices->pluck('id')) }}">
