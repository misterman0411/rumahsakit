...
<?php else: ?>
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="<?php echo e(route('patient.appointments.store')); ?>" method="POST" class="p-8 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="departemen_id" id="departemen_id" required
                        ...
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($dept->id); ?>" <?php echo e(old('departemen_id') == $dept->id ? 'selected' : ''); ?>>
                    ...
                    <select name="dokter_id" id="dokter_id" required
                        ...
                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($doctor->id); ?>" 
                                    data-department="<?php echo e($doctor->departemen_id); ?>"
                                    <?php echo e(old('dokter_id') == $doctor->id ? 'selected' : ''); ?>>
                                <?php echo e($doctor->user->nama ?? 'Dokter'); ?> - <?php echo e($doctor->spesialisasi ?? ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_janji" id="tanggal_janji" required
                           ...
                           value="<?php echo e(old('tanggal_janji')); ?>"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="waktu_janji" id="waktu_janji" required
                        ...
                        <option value="08:00" <?php echo e(old('waktu_janji') == '08:00' ? 'selected' : ''); ?>>08:00 WIB</option>
                        <option value="08:30" <?php echo e(old('waktu_janji') == '08:30' ? 'selected' : ''); ?>>08:30 WIB</option>
                        <option value="09:00" <?php echo e(old('waktu_janji') == '09:00' ? 'selected' : ''); ?>>09:00 WIB</option>
                        <option value="09:30" <?php echo e(old('waktu_janji') == '09:30' ? 'selected' : ''); ?>>09:30 WIB</option>
                        <option value="10:00" <?php echo e(old('waktu_janji') == '10:00' ? 'selected' : ''); ?>>10:00 WIB</option>
                        <option value="10:30" <?php echo e(old('waktu_janji') == '10:30' ? 'selected' : ''); ?>>10:30 WIB</option>
                        <option value="11:00" <?php echo e(old('waktu_janji') == '11:00' ? 'selected' : ''); ?>>11:00 WIB</option>
                        <option value="13:00" <?php echo e(old('waktu_janji') == '13:00' ? 'selected' : ''); ?>>13:00 WIB</option>
                        <option value="13:30" <?php echo e(old('waktu_janji') == '13:30' ? 'selected' : ''); ?>>13:30 WIB</option>
                        <option value="14:00" <?php echo e(old('waktu_janji') == '14:00' ? 'selected' : ''); ?>>14:00 WIB</option>
                        <option value="14:30" <?php echo e(old('waktu_janji') == '14:30' ? 'selected' : ''); ?>>14:30 WIB</option>
                        <option value="15:00" <?php echo e(old('waktu_janji') == '15:00' ? 'selected' : ''); ?>>15:00 WIB</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="keluhan" id="keluhan" rows="4"
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none"><?php echo e(old('keluhan')); ?></textarea>
