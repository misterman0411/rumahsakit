                    ...
                    <div class="bg-indigo-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nama" id="name" required value="<?php echo e(old('nama', $doctor->user->nama)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" required value="<?php echo e(old('email', $doctor->user->email)); ?>"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <div>
                                ...
                                <select name="departemen_id" id="department_id" required
                                    ...
                                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($department->id); ?>" <?php echo e(old('departemen_id', $doctor->departemen_id) == $department->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="spesialisasi" id="specialization" required 
                                    value="<?php echo e(old('specialization', $doctor->spesialisasi)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_lisensi" id="license_number" required 
                                    value="<?php echo e(old('license_number', $doctor->nomor_lisensi)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="telepon" id="phone" required value="<?php echo e(old('telepon', $doctor->telepon)); ?>"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="consultation_fee" id="consultation_fee" required 
                                        value="<?php echo e(old('consultation_fee', $doctor->consultation_fee)); ?>" min="0" step="1000"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rumahsakit\resources\views\doctors\edit.blade.php ENDPATH**/ ?>