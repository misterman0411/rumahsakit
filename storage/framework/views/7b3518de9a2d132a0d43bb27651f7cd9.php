                ...
                <div class="hidden md:block">
                    <div class="flex items-center gap-4">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-2.5 rounded-full font-medium shadow-indigo-200 hover:shadow-lg">Sign Up</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                        ...
                        <div class="p-6 space-y-5">
                            <form method="POST" action="<?php echo e(route('profile.update')); ?>">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $user->nama)); ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition <?php echo e($errors->has('nama') ? 'border-red-500 focus:ring-red-500' : ''); ?>" placeholder="Masukkan nama lengkap">
...
<?php /**PATH C:\Users\User\Desktop\rumahsakit\resources\views\profile\edit-public.blade.php ENDPATH**/ ?>