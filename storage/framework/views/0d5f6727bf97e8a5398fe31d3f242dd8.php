...
<?php endif; ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden border border-gray-100 flex flex-col h-full">
                ...
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <div class="border-t border-gray-100 pt-4 mt-2 flex items-center justify-between">
                        ...
                        <form action="<?php echo e(route('cart.add')); ?>" method="POST" id="addToCartForm-<?php echo e($med->id); ?>" onsubmit="addToCart(event, <?php echo e($med->id); ?>)">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="medication_id" value="<?php echo e($med->id); ?>">
    ...
    <script>
        ...
        function updateCartBadge(count) {
            ...
            const cartIcons = document.querySelectorAll('a[href="<?php echo e(route('cart.index')); ?>"]');
