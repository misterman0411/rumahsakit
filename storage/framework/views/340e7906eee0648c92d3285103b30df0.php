...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Order Radiologi Baru</h1>
            <p class="text-gray-600 mt-2">Buat order pemeriksaan radiologi untuk pasien</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="<?php echo e(route('radiology.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <select name="dokter_id" id="dokter_id" required
                            ...
                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($doctor->id); ?>" 
                                    <?php echo e((old('dokter_id') == $doctor->id || (auth()->user()->dokter && auth()->user()->dokter->id == $doctor->id)) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="jenis_tes_id" id="jenis_tes_id" required
                            ...
                            <?php $__currentLoopData = $testTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($testType->id); ?>" <?php echo e(old('jenis_tes_id') == $testType->id ? 'selected' : ''); ?>>
                                    <?php echo e($testType->nama); ?> - Rp <?php echo e(number_format($testType->harga, 0, ',', '.')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Clinical Indication -->
                    <div>
                        <label for="catatan_klinis" class="block text-sm font-semibold text-gray-700 mb-2">
                            Catatan Klinis
                        </label>
                        <textarea name="catatan_klinis" id="catatan_klinis" rows="4"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                            placeholder="Riwayat klinis, indikasi pemeriksaan, area yang diperiksa, dll"><?php echo e(old('catatan_klinis')); ?></textarea>
                        <?php $__errorArgs = ['catatan_klinis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rs\hospital-management-system\resources\views/radiology/create.blade.php ENDPATH**/ ?>