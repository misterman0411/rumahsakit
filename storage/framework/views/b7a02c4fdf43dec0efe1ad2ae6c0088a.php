                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" id="name" required value="<?php echo e(old('nama', $room->nama)); ?>"
                        ...
                        <div>
                            ...
                            <select name="departemen_id" id="departemen_id" required
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($department->id); ?>" <?php echo e(old('departemen_id', $room->departemen_id) == $department->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="jenis" id="jenis" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                                <option value="vip" <?php echo e(old('jenis', $room->jenis) == 'vip' ? 'selected' : ''); ?>>VIP</option>
                                <option value="kelas_1" <?php echo e(old('jenis', $room->jenis) == 'kelas_1' ? 'selected' : ''); ?>>Kelas 1</option>
                                <option value="kelas_2" <?php echo e(old('jenis', $room->jenis) == 'kelas_2' ? 'selected' : ''); ?>>Kelas 2</option>
                                <option value="kelas_3" <?php echo e(old('jenis', $room->jenis) == 'kelas_3' ? 'selected' : ''); ?>>Kelas 3</option>
                                <option value="icu" <?php echo e(old('jenis', $room->jenis) == 'icu' ? 'selected' : ''); ?>>ICU</option>
                                <option value="isolasi" <?php echo e(old('jenis', $room->jenis) == 'isolasi' ? 'selected' : ''); ?>>Isolasi</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="tarif_per_hari" id="tarif_per_hari" required value="<?php echo e(old('tarif_per_hari', $room->tarif_per_hari)); ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                            <?php $__errorArgs = ['tarif_per_hari'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($room->kapasitas); ?> beds" readonly
                            class="w-full px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-600">
                        <p class="text-sm text-gray-500 mt-1">Capacity cannot be changed. Current beds: <?php echo e($room->tempatTidur->count()); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\rumahsakit\resources\views/rooms/edit.blade.php ENDPATH**/ ?>