...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <option value="<?php echo e($room->id); ?>" data-beds="<?php echo e(json_encode($room->tempatTidur)); ?>" <?php echo e(old('ruangan_id') == $room->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="tanggal_masuk" value="<?php echo e(old('tanggal_masuk', now()->format('Y-m-d\TH:i'))); ?>" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['tanggal_masuk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-8">
                ...
                <textarea name="alasan_masuk" rows="4" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['alasan_masuk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alasan_masuk')); ?></textarea>
                <?php $__errorArgs = ['alasan_masuk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\rumahsakit\resources\views/inpatient/create.blade.php ENDPATH**/ ?>