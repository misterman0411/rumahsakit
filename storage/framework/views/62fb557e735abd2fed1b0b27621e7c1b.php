...
<?php $__env->startSection('title', 'Pembayaran Tertunda'); ?>
<?php $__env->startSection('subtitle', 'Menunggu konfirmasi pembayaran'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="p-8">
            ...
            <!-- Actions -->
            <div class="space-y-3">
                <a href="<?php echo e(route('patient.invoices')); ?>" class="block w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-xl text-center transition-all duration-200 shadow-lg hover:shadow-xl">
                    Cek Status Tagihan
                </a>
                <a href="<?php echo e(route('patient.dashboard')); ?>" class="block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-3 px-6 rounded-xl text-center transition-all">
...
<?php echo $__env->make('layouts.patient', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\rumahsakit\resources\views\patient\payment-pending.blade.php ENDPATH**/ ?>