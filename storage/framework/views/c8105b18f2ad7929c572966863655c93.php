...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-800"><?php echo e($department->nama); ?></h1>
                <p class="text-gray-600 mt-2"><?php echo e($department->code ? "Code: {$department->code}" : 'Department Details'); ?></p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="font-semibold text-gray-900 text-lg"><?php echo e($department->nama); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Code</p>
                            <p class="font-semibold text-gray-900"><?php echo e($department->code ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Head of Department</p>
                            <p class="font-semibold text-gray-900"><?php echo e($department->head_of_department ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Status</p>
                            <span class="inline-flex px-3 py-1 rounded-full text-xs font-semibold
                                <?php if($department->status == 'active'): ?> bg-green-100 text-green-800
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900"><?php echo e($department->telepon ?? 'N/A'); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-gray-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900"><?php echo e($department->email ?? 'N/A'); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-gray-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900"><?php echo e($department->location ?? 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Operating Hours -->
                <?php if($department->operating_hours): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h2 class="text-xl font-bold text-gray-800 mb-4">Operating Hours</h2>
                    <p class="text-gray-700 whitespace-pre-wrap"><?php echo e($department->operating_hours); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <p class="text-gray-700 whitespace-pre-wrap"><?php echo e($department->description); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg text-center">
                            ...
                            <p class="text-3xl font-bold text-blue-900"><?php echo e($department->dokters->count()); ?></p>
                        </div>
                        <div class="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg text-center">
                            ...
                            <p class="text-3xl font-bold text-green-900"><?php echo e($department->ruangans->count()); ?></p>
                        </div>
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg text-center">
                            ...
                            <p class="text-3xl font-bold text-purple-900"><?php echo e($department->ruangans->sum('capacity')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="<?php echo e(route('doctors.index')); ?>?department_id=<?php echo e($department->id); ?>" 
                            class="block w-full px-4 py-2 bg-gray-600 text-white text-center rounded-lg hover:bg-gray-700 transition-colors">
                            View Doctors
                        </a>
                        <a href="<?php echo e(route('rooms.index')); ?>?department_id=<?php echo e($department->id); ?>" 
                            class="block w-full px-4 py-2 bg-gray-600 text-white text-center rounded-lg hover:bg-gray-700 transition-colors">
                            View Rooms
                        </a>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        <div>
                            ...
                            <p class="font-semibold text-gray-900"><?php echo e($department->created_at->format('d M Y, H:i')); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600">Last Updated</p>
                            <p class="font-semibold text-gray-900"><?php echo e($department->updated_at->format('d M Y, H:i')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rumahsakit\resources\views\departments\show.blade.php ENDPATH**/ ?>