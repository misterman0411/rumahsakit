        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-gray-100 transition-all duration-300 group">
                    ...
                    <a href="<?php echo e(route('patient.appointments.book')); ?>" class="text-indigo-600 font-semibold hover:text-indigo-700 flex items-center group-hover:gap-2 transition-all">
