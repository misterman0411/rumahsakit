        ...
        <div class="mb-6 flex justify-between items-start">
            ...
            <div class="flex space-x-2">
                <?php if($radiology->report_status === 'final' && $radiology->image_path): ?>
                    <a href="<?php echo e($radiology->image_url); ?>" target="_blank"
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="bg-gray-100 p-4 rounded-lg">
                        <img src="<?php echo e($radiology->image_url); ?>"
                             alt="Radiology Image"
...
<div id="imageModal" class="hidden fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4" onclick="this.classList.add('hidden')">
    <div class="max-w-6xl w-full">
        <img src="<?php echo e($radiology->image_url); ?>" alt="Radiology Image" class="w-full h-auto">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\rumahsakit\resources\views\radiology\show.blade.php ENDPATH**/ ?>