                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="bg-purple-50 p-4 rounded-lg text-center">
                            <p class="text-3xl font-bold text-purple-600"><?php echo e($doctor->reseps->count()); ?></p>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600"><?php echo e($appointment->janjiTemu_date->format('d M Y, H:i')); ?></p>
                                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('departments.show', $doctor->department)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\rumahsakit\resources\views/doctors/show.blade.php ENDPATH**/ ?>