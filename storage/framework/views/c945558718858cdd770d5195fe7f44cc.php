                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-indigo-600">Rp <?php echo e(number_format($laboratory->tagihan->total_amount, 0, ',', '.')); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Status</p>
                            <span class="inline-flex px-3 py-1 rounded-full text-sm font-semibold
                                <?php if($laboratory->tagihan->status === 'paid'): ?> bg-green-100 text-green-800
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rs\hospital-management-system\resources\views/laboratory/show.blade.php ENDPATH**/ ?>