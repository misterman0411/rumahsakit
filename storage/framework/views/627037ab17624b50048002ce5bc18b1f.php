...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <span class="info-value"><?php echo e($appointment->tanggal_janji->format('d/m/Y')); ?></span>
        </div>
        <div class="info-row">
            <span class="info-label">Waktu:</span>
            <span class="info-value"><?php echo e($appointment->tanggal_janji->format('H:i')); ?></span>
        </div>
        <div class="info-row">
...
<?php /**PATH C:\Users\User\Desktop\rumahsakit\resources\views\queue\ticket.blade.php ENDPATH**/ ?>