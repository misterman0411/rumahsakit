...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-lg overflow-hidden">
        <div class="px-8 py-8 text-white flex items-center space-x-6">
            ...
            <div>
                <h1 class="text-3xl font-bold"><?php echo e(Auth::user()->nama); ?></h1>
                <p class="text-indigo-100 mt-1"><?php echo e(Auth::user()->email); ?></p>
                <div class="flex items-center space-x-2 mt-2">
                    ...
                    <span class="text-indigo-100 text-sm">Terdaftar sejak <?php echo e(Auth::user()->created_at->format('d M Y')); ?></span>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="nama" name="nama" 
                                       ...
                                       required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition <?php echo e($errors->has('nama') ? 'border-red-500 focus:ring-red-500' : ''); ?>"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="email" id="email" name="email" 
                                       ...
                                       required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition <?php echo e($errors->has('email') ? 'border-red-500 focus:ring-red-500' : ''); ?>"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="current_password" name="current_password" 
                                       required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition <?php echo e($errors->has('current_password') ? 'border-red-500 focus:ring-red-500' : ''); ?>"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="password" name="password" 
                                       required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition <?php echo e($errors->has('password') ? 'border-red-500 focus:ring-red-500' : ''); ?>"
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-semibold mt-1"><?php echo e($user->nama); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-semibold mt-1 break-all"><?php echo e($user->email); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-semibold mt-1"><?php echo e($user->created_at->format('d M Y')); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-semibold mt-1"><?php echo e($user->updated_at->format('d M Y H:i')); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rumahsakit\resources\views/profile/edit.blade.php ENDPATH**/ ?>