...
<div class="bg-white shadow rounded-lg">
    ...
    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <p class="mt-1 text-gray-900"><?php echo e($appointment->dokter->nama_lengkap); ?></p>
        ...
        <div>
            ...
            <p class="mt-1 text-gray-900"><?php echo e(\Carbon\Carbon::parse($appointment->janjiTemu_date)->format('d F Y, H:i')); ?></p>
        </div>
        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rs\hospital-management-system\resources\views/appointments/show.blade.php ENDPATH**/ ?>