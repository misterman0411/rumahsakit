            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e(\Carbon\Carbon::parse($appointment->janjiTemu_date)->format('d M Y')); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($appointment->janjiTemu_date)->format('H:i')); ?> WIB</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php
                                $typeLabels = [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hp_5C\Downloads\hospital-management-system-main\resources\views/appointments/index.blade.php ENDPATH**/ ?>