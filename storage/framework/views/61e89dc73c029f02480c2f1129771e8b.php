...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="p-6">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="mt-1 text-gray-900 font-semibold"><?php echo e($invoice->pasien->nama_lengkap); ?></p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500">MRN</label>
                            <p class="mt-1 text-gray-900"><?php echo e($invoice->pasien->mrn); ?></p>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500">Phone</label>
                            <p class="mt-1 text-gray-900"><?php echo e($invoice->pasien->telepon ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php if($invoice->billable_type == 'App\Models\Prescription' && $invoice->billable): ?>
                        <div class="space-y-2">
                            <div class="text-sm">
                                ...
                                <span class="ml-2 text-gray-900"><?php echo e($invoice->billable->nomor_resep); ?></span>
                            </div>
                            <div class="text-sm">
                                <span class="text-gray-500">Doctor:</span>
                                <span class="ml-2 text-gray-900"><?php echo e($invoice->billable->dokter->user->nama ?? '-'); ?></span>
                            </div>
                            <div class="text-sm">
                    ...
                    <?php elseif($invoice->billable_type == 'App\Models\LaboratoryOrder' && $invoice->billable): ?>
                        <div class="space-y-2">
                            ...
                            <div class="text-sm">
                                ...
                                <span class="ml-2 text-gray-900"><?php echo e($invoice->billable->testType->nama ?? '-'); ?></span>
                            </div>
                            <div class="text-sm">
                                <span class="text-gray-500">Doctor:</span>
                                <span class="ml-2 text-gray-900"><?php echo e($invoice->billable->dokter->user->nama ?? '-'); ?></span>
            ...
            <!-- Payment History -->
            <?php if($invoice->pembayarans && $invoice->pembayarans->count() > 0): ?>
            <div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $invoice->pembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php echo e($payment->pembayaran_number); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($payment->pembayaran_date ? date('d M Y H:i', strtotime($payment->pembayaran_date)) : '-'); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($payment->processedBy->nama ?? '-'); ?>
            ...
            <form action="<?php echo e(route('billing.payment', $invoice)); ?>" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="catatan" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\rumahsakit\resources\views/billing/show.blade.php ENDPATH**/ ?>