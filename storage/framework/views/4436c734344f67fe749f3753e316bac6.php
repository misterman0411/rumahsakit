<?php $__env->startSection('title', 'Add Daily Log'); ?>
...
<div class="bg-white shadow rounded-lg">
    ...
    <form action="<?php echo e(route('inpatient.daily-logs.store', $inpatient)); ?>" method="POST" class="p-6">
        <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <label class="relative flex cursor-pointer rounded-lg border p-4 hover:border-blue-500 transition-colors">
                        <input type="radio" name="type" value="<?php echo e($value); ?>" class="sr-only" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="doctor-field">
                ...
                <select name="dokter_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <option value="<?php echo e($doctor->id); ?>" <?php echo e(auth()->user()->role->nama == 'doctor' && auth()->user()->dokter && auth()->user()->dokter->id == $doctor->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="nurse-field">
                ...
                <select name="perawat_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <option value="<?php echo e($nurse->id); ?>" <?php echo e(auth()->user()->role->nama == 'nurse' && auth()->user()->perawat && auth()->user()->perawat->id == $nurse->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="progress_notes" rows="4" required 
                    ...
                    placeholder="Enter detailed progress notes..."><?php echo e(old('progress_notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="doctor-orders-field">
                ...
                <textarea name="doctor_orders" rows="3" 
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Enter doctor's orders..."><?php echo e(old('doctor_orders')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="nurse-notes-field">
                ...
                <textarea name="nurse_notes" rows="3" 
                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Enter nursing notes..."><?php echo e(old('nurse_notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Desktop\rumahsakit\resources\views\inpatient\daily-logs\create.blade.php ENDPATH**/ ?>